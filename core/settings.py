...
ADMINS = (
    (os.environ.get('ADMIN_NAME', 'andreffs18'),
     os.environ.get('ADMIN_EMAIL', 'andreffs18@gmail.com')),
)
MANAGERS = ADMINS
...
STATIC_ROOT = os.path.join(CORE_ROOT, 'staticfiles')
...
STATICFILES_DIRS = (
    ...
    os.path.join(CORE_ROOT, 'staticfiles'),
...
# Django Authentication Variables
LOGIN_URL = "/login/"
LOGOUT_REDIRECT_URL = "/"
LOGIN_REDIRECT_URL = "/"
