...
class GetArticleServiceTestCase(TestCase):
    ...
    @patch("genericpath.isfile", return_value=lambda x: True)
    @patch("_io.TextIOWrapper.read", return_value=lambda x: "# This is a test document")
    def test_call_success(self, mock_article_value):
        ...
        self.assertEqual(mock_article_value.called)
